...
Massoud 1974 and Szabolc 1976

Squires and Glenn 2004
...
\NormalTok{predicters=predictors}\OperatorTok{@}\NormalTok{data[,}\KeywordTok{c}\NormalTok{(}\StringTok{"SI1"}\NormalTok{,}\StringTok{"SI2"}\NormalTok{,}\StringTok{"SI3"}\NormalTok{,}\StringTok{"SI4"}\NormalTok{,}\StringTok{"SI5"}\NormalTok{,}\StringTok{"SI6"}\NormalTok{,}\StringTok{"SAVI"}\NormalTok{,}\StringTok{"VSSI"}\NormalTok{,}\StringTok{"NDS I"}\NormalTok{,}\StringTok{"NDVI"}\NormalTok{,}\StringTok{"SR"}\NormalTok{,}\StringTok{"CRSI"}\NormalTok{, }\StringTok{"BI"}\NormalTok{)]}
...
\NormalTok{soil0=}\KeywordTok{cbind}\NormalTok{(soil0,}\StringTok{"TEXCLASS"}\NormalTok{ =}\KeywordTok{TT.points.in.classes}\NormalTok{(}\DataTypeTok{tri.data =}\NormalTok{SSCP[, }\KeywordTok{c}\NormalTok{(}\StringTok{'CLAY'}\NormalTok{, }\StringTok{'SILT'}\NormalTok{, }\StringTok{'SAND'}\NormalTok{)],}\DataTypeTok{class.sys =} \StringTok{"USDA.TT"}\NormalTok{,	}\DataTypeTok{PiC.type	=} \StringTok{"t"}\NormalTok{,}\DataTypeTok{collapse	=} \StringTok{', '}\NormalTok{))}
...
\KeywordTok{summary}\NormalTok{(soil1}\OperatorTok{$}\NormalTok{X0.}\FloatTok{30.}\NormalTok{cm)}
\NormalTok{Min.	1st Qu.	Median		Mean	3rd Qu.	Max. }\FloatTok{0.0000}		\FloatTok{0.6291}	\FloatTok{1.8709}	\FloatTok{6.6812}		\FloatTok{5.3121} \FloatTok{154.2463}
...
\KeywordTok{hist}\NormalTok{(soil1}\OperatorTok{$}\NormalTok{dummy, }\DataTypeTok{main=}\StringTok{"Frequency distribution (before transformation)"}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{"Harmo nized EC (dS/m)"}\NormalTok{)}
...
\KeywordTok{hist}\NormalTok{(soil1}\OperatorTok{$}\NormalTok{Tran, }\DataTypeTok{main=}\StringTok{"Frequency distribution (after transformation)"}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Harmoniz ed EC (dS/m)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\{}\KeywordTok{plot}\NormalTok{(df.testa}\OperatorTok{$}\NormalTok{Strain}\OperatorTok{~}\NormalTok{df.testa}\OperatorTok{$}\NormalTok{dummy, }\DataTypeTok{xlab=}\StringTok{"Measured ECse"}\NormalTok{,}\DataTypeTok{ylab=}\StringTok{"Modelled ECse"}\NormalTok{, mai }\DataTypeTok{n=}\StringTok{"Accuracy assessment on hold-out samples"}\NormalTok{)}
\OperatorTok{+}	\KeywordTok{abline}\NormalTok{(}\DataTypeTok{a=}\DecValTok{0}\NormalTok{,}\DataTypeTok{b=}\DecValTok{1}\NormalTok{,}\DataTypeTok{lty=}\DecValTok{20}\NormalTok{, }\DataTypeTok{col=}\StringTok{"blue"}\NormalTok{)\} }\CommentTok{# Figure 5.9}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{RMSE=}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(df.testa}\OperatorTok{$}\NormalTok{Strain}\OperatorTok{-}\NormalTok{df.testa}\OperatorTok{$}\NormalTok{dummy,}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\KeywordTok{length}\NormalTok{((df.testa}\OperatorTok{$}\NormalTok{Strain}\OperatorTok{-}\NormalTok{d f.testa}\OperatorTok{$}\NormalTok{dummy)))}
...
\NormalTok{NSE=}\DecValTok{1}\OperatorTok{-}\KeywordTok{sum}\NormalTok{(df.testa}\OperatorTok{$}\NormalTok{Strain}\OperatorTok{-}\NormalTok{df.testa}\OperatorTok{$}\NormalTok{dummy,}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\KeywordTok{sum}\NormalTok{((df.testa}\OperatorTok{$}\NormalTok{Strain}\OperatorTok{-}\KeywordTok{mean}\NormalTok{(df. testa}\OperatorTok{$}\NormalTok{dummy,}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{))}\OperatorTok{^}\DecValTok{2}\NormalTok{,}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
...
\KeywordTok{proj4string}\NormalTok{(df.testa)=}\KeywordTok{CRS}\NormalTok{(}\StringTok{"+proj=utm +zone=36 +datum=WGS84 +units=m +no_defs +ellps= WGS84 +towgs84=0,0,0"}\NormalTok{) }\CommentTok{# Make sure to use correct CRS}
...
\NormalTok{predictors6a=predictors[}\KeywordTok{c}\NormalTok{(}\StringTok{"dem"}\NormalTok{,}\StringTok{"slope"}\NormalTok{,}\StringTok{"cnbl"}\NormalTok{,}\StringTok{"lcover"}\NormalTok{,}\StringTok{"loncurve"}\NormalTok{,}\StringTok{"rain"}\NormalTok{,}\StringTok{"pgeology"}
...
\KeywordTok{spplot}\NormalTok{(pred_uncerta, }\StringTok{"pred_width"}\NormalTok{, }\DataTypeTok{scales =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{draw =} \OtherTok{TRUE}\NormalTok{),}\DataTypeTok{col.regions=}\NormalTok{heat.color }\KeywordTok{s}\NormalTok{(}\DecValTok{20}\NormalTok{,}\DataTypeTok{rev =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{spplot}\NormalTok{(df.testa,}\StringTok{"dummy"}\NormalTok{,}\DataTypeTok{pch=}\DecValTok{3}\NormalTok{,}\DataTypeTok{cex=}\FloatTok{0.4}\NormalTok{) }\CommentTok{#Figure 6.11}
...
\NormalTok{predictors}\OperatorTok{$}\NormalTok{Salt_affected=}\KeywordTok{saltSeverity}\NormalTok{(predictors}\OperatorTok{$}\NormalTok{ECse,predictors}\OperatorTok{$}\NormalTok{PH,predictors}\OperatorTok{$}\NormalTok{ESP,}\StringTok{" FAO"}\NormalTok{)	predictors}\OperatorTok{$}\NormalTok{saltaffectedness=}\KeywordTok{classCode}\NormalTok{(predictors}\OperatorTok{$}\NormalTok{Salt_affected,}\StringTok{"saltseverity"}\NormalTok{)}
...
\CommentTok{# Min. 1st Qu.	Median	Mean 3rd Qu.	Max. 3.0	6.0		8.0		8.5	#11.5	15.0}
...
\KeywordTok{agreementplot}\NormalTok{(}\KeywordTok{confusion}\NormalTok{(soilv}\OperatorTok{$}\NormalTok{salt_affected, soilv}\OperatorTok{$}\NormalTok{salt_affected1),}\DataTypeTok{main =} \StringTok{"Accuracy assessment"}\NormalTok{,}\DataTypeTok{xlab =} \StringTok{"Class codes in holdout samples"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Class codes in map"}\NormalTok{)}
...
\OperatorTok{+}\NormalTok{	ww=EC1}
\OperatorTok{+}\NormalTok{	ww=}\KeywordTok{raster}\NormalTok{(ww)}
\OperatorTok{+}\NormalTok{	ww}\OperatorTok{$}\NormalTok{salt=}\KeywordTok{saltSeverity}\NormalTok{(}\KeywordTok{values}\NormalTok{(EC1),}\KeywordTok{values}\NormalTok{(PH1),}\KeywordTok{values}\NormalTok{(ESP1),}\StringTok{"FAO"}\NormalTok{)}
\OperatorTok{+}\NormalTok{	ww=ww}\OperatorTok{$}\NormalTok{salt; }\KeywordTok{names}\NormalTok{(ww)=}\KeywordTok{c}\NormalTok{(}\StringTok{"salt"}\NormalTok{)}
\OperatorTok{+}\NormalTok{	ww}
